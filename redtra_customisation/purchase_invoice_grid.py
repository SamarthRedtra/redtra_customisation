"""Default Purchase Invoice item-grid layout."""
...
def apply_purchase_invoice_item_grid_defaults_to_users():
	"""Set the approved grid layout for every active Desk user."""
	apply_grid_default_to_users(PARENT_DOCTYPE, CHILD_DOCTYPE, PURCHASE_INVOICE_ITEM_COLUMNS)


def get_purchase_invoice_item_columns():
	return [dict(column) for column in PURCHASE_INVOICE_ITEM_COLUMNS]
