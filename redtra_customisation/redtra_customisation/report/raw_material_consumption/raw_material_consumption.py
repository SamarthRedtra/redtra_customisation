...
def get_columns():
	return [
		{"label": _("Code"), "fieldname": "item", "fieldtype": "Data", "width": 180},
...
def get_data(filters):
	...
	conditions.append("sed.is_finished_item = 0 AND sed.is_scrap_item = 0")
	...
	for row in sed_records:
		...
		if operation == "ACC Injection Moulding": op_label = "ACC'"
		elif operation == "Blow Moulding": op_label = "WPB'"
		elif operation == "Labeling": op_label = "WPL'"
		elif operation == "Printing": op_label = "WPP'"
		elif operation == "Wadding": op_label = "WPW'"
